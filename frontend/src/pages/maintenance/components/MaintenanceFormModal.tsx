...
export default function MaintenanceFormModal({ onClose }: Props) {
  ...
  const mutation = useMutation({
    mutationFn: (data: MaintenanceFormData) => api.post('/maintenances', {
      ...data,
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="modal-form">
          ...
          <div className="modal-footer">
            ...
            <button type="submit" className="btn-primary" disabled={mutation.isPending}>
              ...
              <span>{mutation.isPending ? 'Salvando...' : 'Salvar Manutenção'}</span>
            </button>
          </div>
        </form>
      </div>
